...
import premioResolve from './premio-routing-resolve.service';

describe('Premio routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: PremioService;
  let resultPremio: IPremio | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IPremio returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        premioResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultPremio = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultPremio).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IPremio>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
